...
@section("content")
    <form class="form-horizontal" method="post">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="name" placeholder="" name="title" value="{{$data->title}}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="datetime-local" class="form-control" id="name" placeholder="" name="start_time" value="{{$data->start_time}}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="datetime-local" class="form-control" id="name" placeholder="" name="end_time" value="{{$data->end_time}}">
            </div>
        </div>
