...
@section("content")
    <form class="form-horizontal" method="post">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="name" placeholder="" name="name" value="{{$menucate->name}}">
            </div>
        </div>
        <div class="form-group">
            {{csrf_field()}}
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="type_id" placeholder="" name="type_id" value="{{$menucate->type_id}}">
            </div>
        </div>
        <div class="form-group">
            {{csrf_field()}}
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="description" placeholder="" name="description" value="{{$menucate->description}}">
            </div>
        </div>
