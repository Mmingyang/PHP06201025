...
<?php $__env->startSection("content"); ?>
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <select name="menu_cate_id" class="form-control">
                    ...
                    <?php $__currentLoopData = $cates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mys): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" placeholder="" name="goods_price" value="<?php echo e($menu->goods_price); ?>">
            </div>
        </div>
    ...
    <script>
        ...
        jQuery(function () {
            ...
            uploader = WebUploader.create({
                ...
                // 文件接收服务端。
                server: '<?php echo e(route("shop.menu.upload")); ?>',
