<?php $__env->startSection("title","抽奖活动奖品编辑"); ?>
...
<?php $__env->startSection("content"); ?>
    ...
    <form class="form-horizontal" method="post">
            ...
            <div class="col-sm-10">
                <select name="activity_id" class="form-control">
                    ...
                    <?php $__currentLoopData = $eventList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($event->id); ?>" <?php if($events->activity_id==$event->id): ?> selected <?php endif; ?> ><?php echo e($event->title); ?></option>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="name" placeholder="" name="name" value="<?php echo e($events->name); ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <script id="container" name="description" type="text/plain"><?php echo e($events->description); ?></script>
            </div>
        </div>
